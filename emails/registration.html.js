     ...
     <html lang="en">
       ...
       <div class="container">
         ...
         <div class="otp">
           ...
           <p>You can <a href="${process.env.BACKEND_BASE_URL}/api/verifyOTPFromEmail?email=${email}&OTP=${OTP}">click here</a> to verify the OTP.</p>
         </div>
         <div class="info">
           <p>Please note that this OTP will expire after 5 minutes. If it expires, you will need to sign up again.</p>
         </div>
         <div class="footer">
