...
const {
  ...
  saveUploadedUsers,
  getUserUploadReport,
} = require("../controllers/user/import.controller");
...
userRouter.post("/user", verifyToken, checkPermissions(PERMISSIONS.CREATE_USER), createUser);
userRouter.post(
  "/user/addUsers",
  verifyToken,
